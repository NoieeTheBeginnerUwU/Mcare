  ...
  return (
    <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'start',backgroundColor:'white'}}>
      <View style={{width:'100%',height:'10%',flexDirection:'row',alignItems:'center',justifyContent:'center',backgroundColor:'ghostwhite'}}>
        <TouchableOpacity onPress={()=> setActive("checkup")} style={{width:'23%',height:'80%',backgroundColor:active==="checkup"?"navy":'transparent',color:active==="checkup"?"white":'black',alignItems:'center',justifyContent:'center',borderBottomWidth:active==="checkup"?4:0,borderBottomColor:active==="checkup"?"navy":"transparent",}}>
          <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'center'}}>
            <Text style={{fontSize:12,fontWeight:500,textAlign:'center',color:active==="checkup"?"white":'black',}}>Check-up History</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=> setActive("medical")} style={{width:'23%',height:'80%',backgroundColor:active==="medical"?"navy":'transparent',color:active==="medical"?"white":'black',alignItems:'center',justifyContent:'center',borderBottomWidth:active==="medical"?4:0,borderBottomColor:active==="medical"?"navy":"transparent",}}>
          <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'center'}}>
            <Text style={{fontSize:12,fontWeight:500,textAlign:'center',color:active==="medical"?"white":'black',}}>Medical History</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=> setActive("pregnancy")} style={{width:'23%',height:'80%',backgroundColor:active==="pregnancy"?"navy":'transparent',color:active==="pregnancy"?"white":'black',alignItems:'center',justifyContent:'center',borderBottomWidth:active==="pregnancy"?4:0,borderBottomColor:active==="pregnancy"?"navy":"transparent",}}>
          <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'center'}}>
            <Text style={{fontSize:12,fontWeight:500,textAlign:'center',color:active==="pregnancy"?"white":'black',}}>Pregnancy History</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=> setActive("immunization")} style={{width:'23%',height:'80%',backgroundColor:active==="immunization"?"navy":'transparent',color:active==="immunization"?"white":'black',alignItems:'center',justifyContent:'center',borderBottomWidth:active==="immunization"?4:0,borderBottomColor:active==="immunization"?"navy":"transparent",}}>
          <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'center'}}>
            <Text style={{fontSize:12,fontWeight:500,textAlign:'center',color:active==="immunization"?"white":'black',}}>Immunization History</Text>
          </View>
        </TouchableOpacity>
      </View>
            ...
            appointments.map((doc)=>(
              <>
                ...
                </TouchableOpacity>
                {
                  ...
                  <View style={{width:'90%',height:600,backgroundColor:'white',alignSelf:'center',marginTop:0,alignItems:'center',justifyContent:'start',borderWidth:activeAppointment===doc.id&&activeAppointmentToggle===true?1:0}}>
          ...
          <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'space-evenly'}}>
            {
              history.map((doc)=>(
                <>
                  ...
                  {
                    doc.userChildDateOfDelivery1!==""&&
                    <View style={{width:'96%',height:700,borderWidth:1,borderColor:'lightgrey',alignItems:'start',justifyContent:'start',marginTop:20}}>
      ...
      }
      {
        ...
        <ScrollView style={{width:'100%',height:'100%',}}>
          <View style={{width:'100%',height:'100%',alignItems:'center',justifyContent:'space-evenly'}}>
            {
              history.map((doc)=>(
                <View style={{width:'90%',height:402,borderWidth:1,alignItems:'start',justifyContent:'start',marginTop:20}}>
